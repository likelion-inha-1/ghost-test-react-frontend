...
- **선택 후 반응 텍스트 (채택 확정)**: 선택 직후 해당 선택지의 반응 스토리(`reactionText`)를 연출로 노출 후 다음 질문 진행 — 이 상태의 비주얼 디자인은 시안 필요 (잔여 이슈).
...
- **학교별 유형 분포 뷰는 아직 디자인 없음** — 이 화면의 변형(학교 필터 탭 등)으로 협의 필요. (학교 간 참여 랭킹은 MVP 제외 결정 — 2026-07-19)
...
**잔여 이슈**
- 학교별 유형 분포 화면 디자인 없음 (순위 페이지 변형으로 협의 · 학교 간 랭킹은 MVP 제외)
- 질문 화면 "Q1/16" → "Q1/8" 시안 수정 필요
- 선택 후 반응 텍스트(reactionText) 연출 시안 필요
